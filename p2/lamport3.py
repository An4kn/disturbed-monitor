...
class DisturbedMonitor:
    ...
    def get_message(self,shared_data):
        while True:
            ...
            try:
                ...
                print(f"Ostrzeżenie: Otrzymano nieznany typ wiadomości: {data.get('msg_type')}")
                continue
    ...
    def handle_release_message(self, data, shared_data):
        ...
        if not self.critical_section_queue or self.critical_section_queue[0][0] != data["From_process"]:
             # Ignoruj nieoczekiwane komunikaty o zwolnieniu
             return None
        ...
        try:
            ...
            print(f"Ostrzeżenie: Otrzymano nieznany status zwolnienia: {data.get('Status')}")
            return None
    ...
    def notify(self,shared_data,condition_name):
        ...
        # Notify nie czeka na odpowiedź, więc nie powinno nic zwracać
